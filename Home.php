...
<html>
<head>
<title>Home - AppointVaccine</title>
			...
			<div class="content-grids">
						...
						<div class="features-text">
							...
							<div class='tg-wrap'>
								...
								foreach ( $appHist as $app ) {
									echo "<tr><td>$app[4]</td><td>$app[2] ($app[1])</td><td>$app[5]</td>";
						...
						<div class="features-text">
							...
							if (count ( $upcApp ) > 0) {
								...
								foreach ( $upcApp as $app ) {
									echo "<tr><td>$app[4]</td><td>$app[5]</td><td>$app[2] ($app[1])</td>";
									echo "<td>";
									$avgRate = "-";
									...
									echo "$avgRate/5</td>";
									echo "<td><a href='MakeAppointment.php?appId=" . $app [0] . "'>New/Modify</a><br />";
				...
				<div class="col-md-4 testi">
					<div class="work-title testi-title">
						<h3>
							YOUR<span>PREFERRED VACCINE</span>
						</h3>
					</div>
					...
					<div id="top" class="callbacks_container">
						...
						<?php
						if ($prefDoctor != null) {
							echo "<h4>$doctorFirstName ($prefDoctorSpec)</h4>
						...
						foreach ( $doctors as $doc ) {
							if ($doc [0] == $prefDoctor)
								echo "<option selected value='$doc[0]'>$doc[1] ($doc[3]) - $doc[5]/5</option>";
							else
								echo "<option value='$doc[0]'>$doc[1] ($doc[3]) - $doc[5]/5</option>";
						}
						?>
						</select>
						<script type="text/javascript">
